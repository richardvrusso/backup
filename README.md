...
| ![NVMe SSD](https://m.media-amazon.com/images/I/61tEpX718ML._AC_SL1000_.jpg) | [Crucial P3 500GB PCIe Gen3 3D NAND NVMe M.2 SSD](https://a.co/d/0bDVI8Bs){:target="_blank"} | PCIe Generation 3.0 NVMe solid state drive in M.2 2280 form factor<br>• *Delivers up to 3500MB/s sequential reads, offering a highly responsive boot drive or high-speed cache tier* |
